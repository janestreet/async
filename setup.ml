(* OASIS_START *)
(* DO NOT EDIT (digest: 2ff36efefe23a621c32d6352db88d2a8) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/async";
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("async_extra", None);
                   ...
                   {
                      lib_modules =
                        ["Clock_unit_tests"; "Scheduler_unit_tests"; "Std"];
                      lib_pack = true;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "async"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "handlers.ml"});
               Executable
                 ({
                     cs_name = "loop";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "loop.ml"});
               Executable
                 ({
                     cs_name = "nanos_per_job";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "nanos_per_job.ml"});
               Executable
                 ({
                     cs_name = "queens";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "queens.ml"});
               Executable
                 ({
                     cs_name = "squash";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "squash.ml"});
               Executable
                 ({
                     cs_name = "tco";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "tco.ml"})
            ];
          plugins =
            [
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\1381\188y'\022O?\246\247\156\204\137h\221\237";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
