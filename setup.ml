(* OASIS_START *)
(* DO NOT EDIT (digest: f5be06cc70de104e1150f7e389e1ef9b) *)
(*
...
let setup_t =
  {
     ...
     doc = [("async", OCamlbuildDocPlugin.doc_build "lib")];
     ...
     clean_doc = [("async", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test =
       [
          ("test_runner",
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "Jane street's async library";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\183\133\2386,F\031\158\252\177P\143\153\188\165e";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
